...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.CatalogID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["catalogID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: catalogID"))
	}
	r.ko.Spec.CatalogID = &primaryKey
