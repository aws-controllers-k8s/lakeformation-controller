...
const (
	FinalizerString = "finalizers.lakeformation.services.k8s.aws/DatabasePermission"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("databasepermissions")
	GroupKind            = metav1.GroupKind{
		Group: "lakeformation.services.k8s.aws",
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.DatabasePermission{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.DatabasePermission),
	}
}
