...
// +kubebuilder:rbac:groups=lakeformation.services.k8s.aws,resources=databasepermissions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lakeformation.services.k8s.aws,resources=databasepermissions/status,verbs=get;update;patch
